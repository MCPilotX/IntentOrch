...
```typescript
import { MCPilotSDK, createSDK } from '@mcpilotx/intentorch';
...
### 传输配置
```typescript
import { TransportConfig, StdioLogFilterConfig } from '@mcpilotx/intentorch';
...
### AI提供商配置
```typescript
import { AIConfig } from '@mcpilotx/intentorch';
...
### 内置MCP常量
```typescript
import { MCP_METHODS, MCP_ERROR_CODES } from '@mcpilotx/intentorch';
...
### 工具类别和模式
```typescript
import { TOOL_CATEGORIES, TOOL_PATTERNS } from '@mcpilotx/intentorch';
